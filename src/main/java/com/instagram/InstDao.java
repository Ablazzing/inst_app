...
public class InstDao implements Closeable {
    ...
    private static final String PASSWORD = "terrrr";
    ...
    public boolean fillData() {
        String fillTablesSql = SqlUtil.readSqlFile("sql/fill_data.sql");
    ...
    public String getUserInfo(int id) {
        String userSql = String.format(SqlUtil.readSqlFile("sql/userinfo.txt", "\n"), id);
        try (Statement statement = connection.createStatement()) {
